...
@Path("OldBonitaService")
public class OldBonitaService implements ResourceContainer {
  private static Log logger = ExoLogger.getLogger(OldBonitaService.class);
  ...
  public InputStream getResponseAsInputStream(PostMethod httpMethod, String userName) {
    ...
    try {
      ...
      Credentials credsCredentials = new UsernamePasswordCredentials(REST_USER, REST_PASS);
